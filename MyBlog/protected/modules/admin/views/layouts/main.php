	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="<?php echo Yii::app()->request->baseUrl;?>/site/index"><?php echo Yii::app()->name ?></a>
				<div class="nav-collapse">
					<?php $this->widget('zii.widgets.CMenu',array(
						...
						'items'=>array(
							...
							array('label'=>'Categories', 'url'=>array('/admin/category', 'view'=>'about')),
							array('label'=>'Pages', 'url'=>array('/admin/page', 'view'=>'about')),
							array('label'=>'Users', 'url'=>array('/admin/user', 'view'=>'about')),
							array('label'=>'Settings', 'url'=>array('/admin/settings', 'view'=>'about')),
							array('label'=>'Commentaries', 'url'=>array('/admin/commentary', 'view'=>'about')),
